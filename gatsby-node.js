...
exports.createPages = async ({ actions, graphql }) => {
  ...
  const postTemplate = path.resolve("templates/postTemplate.js");
  const bioTemplate = path.resolve("templates/bioTemplate.js");
  const tagTemplate = path.resolve("templates/tagTemplate.js");
